...
//        }
    ...
    public void onBindViewHolder(@NonNull MessageAdapter.ViewHolder holder, int position) {
        ...
        if (imageurl.toString()=="default"){
            ...
            Picasso.get().load(imageurl).placeholder(R.drawable.profile_image).into(holder.profile_image);
            //Picasso.get().load(imageurl).placeholder(R.drawable.ic_image_black_24dp).into(holder.show_image);
        }
        if (position==mChat.size()-1){
            if (chat.isIsseen()){
             ...
             //   holder.image_seen.setText("delivered");
            }
        }else {
